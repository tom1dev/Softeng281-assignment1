...
public class MainTest {
  ...
  public static class YourTests extends CliTest {
    ...
    public void TY_01_your_own_test() throws Exception {
      ...
      assertContains("Database has 1 profile:");
      assertContains("1: Jordan, 21");
      assertDoesNotContain("2: Jordan,25");
    }

    @Test
    public void TY_02_your_own_test() throws Exception {
      // Write your own test here, in the same format as the other tests.
      runCommands(CREATE_PROFILE, "jorDan", "-1", CREATE_PROFILE, "jorDAN", "25", PRINT_DB);
      assertContains("Database has 1 profile:");
      assertContains("1: Jordan, 25");
      assertDoesNotContain("2: Jordan,21");
    }

    @Test
    public void TY_03_your_own_test() throws Exception {
      // Write your own test here, in the same format as the other tests.
      runCommands(CREATE_PROFILE, "jordan", "twe2", CREATE_PROFILE, "Kill2", "25", PRINT_DB);
      assertContains("Database has 1 profile:");
      assertContains("1: Kill2, 25");
      assertDoesNotContain("2: Jordan,21");
    }
